...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v36/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview36";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title"> 2022 Kia Sonet GTX Plus 1.5 </h2>
                  <p className="para">
