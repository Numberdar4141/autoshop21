...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v37/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview37";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title">2016 Toyota Innova Crysta 2.7 V </h2>
                  <p className="para">
