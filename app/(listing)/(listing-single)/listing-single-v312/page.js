...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v38/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview38";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title">  HTxccc2019 Maruti Suzuki Swift ZDi Plus AMT </h2>
                  <p className="para">
