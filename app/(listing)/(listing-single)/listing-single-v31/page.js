...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v31/ProductGallery";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title">2018 Maruti Suzuki Baleno Delta Petrol  </h2>
                  <p className="para">
