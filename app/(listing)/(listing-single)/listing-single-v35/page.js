...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v35/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview35";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title"> 2019 Nissan Kicks XV Premium (O) Dual Tone</h2>
                  <p className="para">
