...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v32/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview32";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title"> 2021 Mahindra XUV500 W11 AT </h2>
                  <p className="para">
