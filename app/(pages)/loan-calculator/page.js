          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="breadcrumb_content style2">
                <h2 className="breadcrumb_title">Sell your Car at Best price</h2>
                <p className="subtitle">Sell car</p>
          ...
          <div className="row">
            <div className="col-md-7 col-xl-8">
              <div className="service_form mb30-sm">
                <h5 className="title">Your Car Details</h5>
                <LoanCalculator />
              </div>
            </div>
            {/* End col */}
